    ...
    <header className="sticky top-0 z-50 bg-cream/70 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-8 px-6 py-5 sm:px-8">
        ...
        <div className="hidden items-center gap-10 md:flex">
          ...
          <Link
            href="/massage"
            className="rounded-full bg-orange px-6 py-2.5 font-sans text-[11px] font-light uppercase tracking-[0.18em] text-cream transition-colors hover:bg-deep"
          >
            Book
          </Link>
        </div>
        ...
        <div className="border-t border-mid/10 bg-cream/95 backdrop-blur-md md:hidden">
          <nav className="mx-auto flex max-w-6xl flex-col px-6 py-4">
            ...
            <Link
              href="/massage"
              onClick={() => setOpen(false)}
              className="mt-3 rounded-full bg-orange px-6 py-3 text-center font-sans text-[12px] font-light uppercase tracking-[0.18em] text-cream transition-colors hover:bg-deep"
            >
              Book
            </Link>
          </nav>
