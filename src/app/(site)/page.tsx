...
export default async function HomePage() {
  ...
  const reviewsSubtext = home?.reviewsSubtext ?? '5.0 · Verified on MassageBook'
  const ceilingCaption =
    home?.ceilingCaption ?? 'The view from the massage table.'
          ...
          <section className="px-6 pb-12 pt-8">
            <div className="text-center">
              ...
              <p className="mt-5 font-sans text-sm tracking-[0.04em] text-mid">
                <span className="text-gold">★★★★★</span>&nbsp;&nbsp;{reviewsSubtext}
              </p>
            </div>
